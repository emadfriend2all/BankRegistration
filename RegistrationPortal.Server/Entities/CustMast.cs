...
namespace RegistrationPortal.Server.Entities
{
    ...
    public class CustMast
    {
        ...
        [Column("branch_c_code", TypeName = "VARCHAR2(10 BYTE)")]
        [Required]
        [StringLength(10)]
        ...
        [Column("cust_c_name", TypeName = "VARCHAR2(250 BYTE)")]
        [Required]
        [StringLength(250)]
        ...
        [Column("cust_c_fname", TypeName = "VARCHAR2(250 BYTE)")]
        [StringLength(250)]
        public string? CustCFname { get; set; }

        [Column("cust_c_sname", TypeName = "VARCHAR2(250 BYTE)")]
        [StringLength(250)]
        public string? CustCSname { get; set; }

        [Column("cust_c_tname", TypeName = "VARCHAR2(250 BYTE)")]
        [StringLength(250)]
        public string? CustCTname { get; set; }

        [Column("cust_c_foname", TypeName = "VARCHAR2(250 BYTE)")]
        [StringLength(250)]
        public string? CustCFoname { get; set; }

        [Column("cust_c_mname", TypeName = "VARCHAR2(250 BYTE)")]
        [StringLength(250)]
        ...
        [Column("cust_c_sex", TypeName = "VARCHAR2(10 BYTE)")]
        [StringLength(10)]
        public string? CustCSex { get; set; }

        [Column("cust_c_religion", TypeName = "VARCHAR2(20 BYTE)")]
        [StringLength(20)]
        public string? CustCReligion { get; set; }

        [Column("cust_c_caste", TypeName = "VARCHAR2(50 BYTE)")]
        [StringLength(50)]
        public string? CustCCaste { get; set; }

        [Column("cust_c_maritalsts", TypeName = "VARCHAR2(20 BYTE)")]
        [StringLength(20)]
        public string? CustCMaritalsts { get; set; }

        [Column("cust_c_padd1", TypeName = "VARCHAR2(100 BYTE)")]
        [StringLength(100)]
        public string? CustCPadd1 { get; set; }

        [Column("cust_c_pcity", TypeName = "VARCHAR2(50 BYTE)")]
        [StringLength(50)]
        public string? CustCPCity { get; set; }

        [Column("mobile_c_no", TypeName = "VARCHAR2(18 BYTE)")]
        [StringLength(18)]
        public string? MobileCNo { get; set; }

        [Column("email_c_add", TypeName = "VARCHAR2(50 BYTE)")]
        [StringLength(50)]
        public string? EmailCAdd { get; set; }

        [Column("id_c_type", TypeName = "VARCHAR2(50 BYTE)")]
        [StringLength(50)]
        public string? IdCType { get; set; }

        [Column("id_c_no", TypeName = "VARCHAR2(50 BYTE)")]
        [StringLength(50)]
        ...
        [Column("id_c_issplace", TypeName = "VARCHAR2(50 BYTE)")]
        [StringLength(50)]
        ...
        [Column("cust_c_authority", TypeName = "VARCHAR2(50 BYTE)")]
        [StringLength(50)]
        public string? CustCAuthority { get; set; }

        [Column("husb_c_name", TypeName = "VARCHAR2(100 BYTE)")]
        [StringLength(100)]
        public string? HusbCName { get; set; }

        [Column("country_c_code", TypeName = "VARCHAR2(50 BYTE)")]
        [StringLength(50)]
        public string? CountryCCode { get; set; }

        [Column("place_c_birth", TypeName = "VARCHAR2(100 BYTE)")]
        [StringLength(100)]
        public string? PlaceCBirth { get; set; }

        [Column("cust_c_nationality", TypeName = "VARCHAR2(100 BYTE)")]
        [StringLength(100)]
        public string? CustCNationality { get; set; }

        [Column("cust_c_wife1", TypeName = "VARCHAR2(250 BYTE)")]
        [StringLength(250)]
        public string? CustCWife1 { get; set; }

        [Column("id_c_type2", TypeName = "VARCHAR2(50 BYTE)")]
        [StringLength(50)]
        public string? IdCType2 { get; set; }

        [Column("id_c_no2", TypeName = "VARCHAR2(50 BYTE)")]
        [StringLength(50)]
        public string? IdCNo2 { get; set; }

        [Column("cust_c_occupation", TypeName = "VARCHAR2(100 BYTE)")]
        [StringLength(100)]
        ...
        [Column("cust_i_identify", TypeName = "VARCHAR2(20 BYTE)")]
        [StringLength(20)]
        public string? CustIIdentify { get; set; }

        [Column("cust_c_countrybrith", TypeName = "VARCHAR2(50 BYTE)")]
        [StringLength(50)]
        public string? CustCCountrybrith { get; set; }

        [Column("cust_c_statebrith", TypeName = "VARCHAR2(10 BYTE)")]
        [StringLength(10)]
        public string? CustCStatebrith { get; set; }

        [Column("cust_c_citizenship", TypeName = "VARCHAR2(50 BYTE)")]
        [StringLength(50)]
        public string? CustCCitizenship { get; set; }

        [Column("cust_c_employer", TypeName = "VARCHAR2(50 BYTE)")]
        [StringLength(50)]
        ...
        [Column("cust_c_higheducation", TypeName = "VARCHAR2(50 BYTE)")]
        [StringLength(50)]
        ...
        [Column("trade_c_nameenglish", TypeName = "VARCHAR2(250 BYTE)")]
        [StringLength(250)]
        public string? TradeCNameenglish { get; set; }

        [Column("cust_c_engfname", TypeName = "VARCHAR2(250 BYTE)")]
        [StringLength(250)]
        public string? CustCEngfname { get; set; }

        [Column("cust_c_engsname", TypeName = "VARCHAR2(250 BYTE)")]
        [StringLength(250)]
        public string? CustCEngsname { get; set; }

        [Column("cust_c_engtname", TypeName = "VARCHAR2(250 BYTE)")]
        [StringLength(250)]
